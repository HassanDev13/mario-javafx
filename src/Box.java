...
public class Box {
    ...
    public Box(int x, int y) {
        ...
        this.x = x;
        this.y = y;
        image[0] = new Image("file:images/box/box0.png");
        image[1] = new Image("file:images/box/box1.png");
        image[2] = new Image("file:images/box/box2.png");
        image[3] = new Image("file:images/box/box3.png"); // box was used
        this.i = 0;
    }
