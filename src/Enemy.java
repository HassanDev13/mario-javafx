...
public class Enemy {
    ...
    public Enemy() {
        super();
        image[0] = new Image("file:images/enemy/enemy1.png");
        image[1] = new Image("file:images/enemy/enemy2.png");
        this.x = 800;
        this.y = (int) (550 - 85 - image[0].getHeight()) - 150;
        this.floor = y;
        this.goLeft = true;
        this.dead = 0;
        this.moveLength = 2;
    ...
    void killed() {
        image[0] = new Image("file:images/enemy/enemyDead.png");
        image[1] = new Image("file:images/enemy/enemyDead.png");
    ...
    private void changeMovingSite(Enemy enemy) {
        if (goLeft) {
            goLeft = false;
            if (enemy != null) {
                if (!enemy.getGoLeft())
